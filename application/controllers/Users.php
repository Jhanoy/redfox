...
class Users extends Admin_Controller 
{
	...
	public function index()
	{
		...
		foreach ($user_data as $k => $v) {
			...
			$user_store = $this->model_user_store->getUserStoreData($v['id']);
			$result[$k]['user_store'] = $this->model_stores->getStoresData($user_store['store_id']);
		}
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$create = $this->model_users->create($data, $this->input->post('groups'), $this->input->post('store'));
        	if($create == true) {
