    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
            ...
            <li class="treeview" id="mainGroupNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createGroup', $user_permission)): ?>
                  <li id="addGroupNav"><a href="<?php echo base_url('groups/create') ?>"><i class="fa fa-circle-o"></i> Add Persmission</a></li>
                <?php endif; ?>
                <?php if(in_array('updateGroup', $user_permission) || in_array('viewGroup', $user_permission) || in_array('deleteGroup', $user_permission)): ?>
                <li id="manageGroupNav"><a href="<?php echo base_url('groups') ?>"><i class="fa fa-circle-o"></i> Manage Permissions</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
            ...
            <li class="treeview" id="mainProductNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createProduct', $user_permission)): ?>
                  <li id="addProductNav"><a href="<?php echo base_url('products/create') ?>"><i class="fa fa-circle-o"></i> Add New Product</a></li>
                <?php endif; ?>

                <!-- //////////////////////// Add Stock /////////////////////////// -->
                
                <?php if(in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
                <li id="manageProductNav"><a href="<?php echo base_url('products/addStock') ?>"><i class="fa fa-circle-o"></i> Add Stock</a></li>
                <?php endif; ?>
          ...
          <?php if(in_array('createOrder', $user_permission) || in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
            <li class="treeview" id="mainQuotesNav">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createOrder', $user_permission)): ?>
                  <li id="addQuoteNav"><a href="<?php echo base_url('quote/create') ?>"><i class="fa fa-circle-o"></i> Add New Quotation</a></li>
                <?php endif; ?>
                <?php if(in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
                <li id="manageQuoteNav"><a href="<?php echo base_url('quote') ?>"><i class="fa fa-circle-o"></i> Manage Quotations</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>          
...
<!-- ////////////////////////////////////////////  REPORT  //////////////////////////////////////////////////// -->
          ...
          <?php if(in_array('viewReports', $user_permission)): ?>
            <li class="treeview" id="mainReportsNav">
              ...
              <ul class="treeview-menu">
                <li id="generalReportsNav"><a href="<?php echo base_url('reports') ?>"><i class="fa fa-circle-o"></i>General Report</a></li>
                <li id="productReportsNav"><a href="<?php echo base_url('reports/products') ?>"><i class="fa fa-circle-o"></i>Product Report</a></li>
                <li id="salesReportsNav"><a href="<?php echo base_url('reports/sales') ?>"><i class="fa fa-circle-o"></i>Sales Report</a></li>
                <li id="employeeSalesReportsNav"><a href="<?php echo base_url('reports/user_sales') ?>"><i class="fa fa-circle-o"></i>Employee Sales Report</a></li>
                <li id="CustomerReportsNav"><a href="<?php echo base_url('reports/customers_report') ?>"><i class="fa fa-circle-o"></i>Customers Purchase Report</a></li>
              </ul>  
            </li>
          <?php endif; ?>
