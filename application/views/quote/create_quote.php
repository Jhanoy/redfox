    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" id="frm" action="<?php base_url('quote/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////  -->
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-success">Create Proforma Invoice</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#mainQuotesNav").addClass('active');
    $("#addQuoteNav").addClass('active');
